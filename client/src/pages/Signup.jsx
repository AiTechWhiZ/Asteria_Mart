...
/* ─────────────────────────────────────────────
   Inline styles — mirrors Login.jsx exactly
───────────────────────────────────────────── */
const css = `
...
export default function Signup() {
  ...
  return (
    <section className={`astaria-signup-root ${themeClass}`}>
      {/* Background blobs */}
      ...
      <div className="as-card">
        ...
        {/* Heading */}
        <h1 className="as-heading">
          Join <span className="as-heading-accent">Astaria.</span>
        </h1>
        <p className="as-sub">
          Create your free account — unlock cart, orders, wishlist & more.
        </p>
        ...
        <div className="as-socials">
          ...
          <button
            type="button"
            className="as-social-btn"
            onClick={() => toast("Apple sign-up coming soon")}
          >
            <svg
              width="15"
              height="16"
        ...
        <div className="as-divider">
          ...
          <span className="as-divider-text">or sign up with email</span>
          <div className="as-divider-line" />
        </div>
        ...
        <form className="as-form" onSubmit={submit}>
          ...
          <div className="as-field">
            ...
            <input
              className="as-input no-right-icon"
              type="text"
            ...
            <div className="as-strength">
              <div className="as-strength-bars">
                {[1, 2, 3, 4].map((n) => (
                  <div
                    key={n}
                    className={`as-strength-bar${strength.score >= n ? ` active-${strength.key}` : ""}`}
                  />
                ))}
              </div>
              <span className="as-strength-label">{strength.label}</span>
            </div>
          )}
          ...
          <div className="as-terms">
            ...
            />
            <label htmlFor="as-agree" className="as-terms-text">
              I agree to Astaria's <Link to="/terms">Terms of Service</Link> and{" "}
              <Link to="/privacy">Privacy Policy</Link>
            </label>
          </div>

          {/* Submit */}
          <button className="as-btn-primary" type="submit" disabled={loading}>
            <span>
              {loading ? (
                <>
